...
public class CustomMenuAdapterVitaminA extends RecyclerView.Adapter<CustomMenuAdapterVitaminA.CustomViewHolder>{
    ...
    public CustomMenuAdapterVitaminA(ArrayList<SmoothieItem> smoothieItems){
