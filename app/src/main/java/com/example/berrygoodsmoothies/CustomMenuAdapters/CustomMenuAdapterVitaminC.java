...
public class CustomMenuAdapterVitaminC extends RecyclerView.Adapter<CustomMenuAdapterVitaminC.CustomViewHolder>{
    ...
    public CustomMenuAdapterVitaminC(ArrayList<SmoothieItem> smoothieItems){
